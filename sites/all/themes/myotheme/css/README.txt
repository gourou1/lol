...
To use these stylesheets, rename the files and myotheme with the name of your theme.
...
myotheme-alpha-default-narrow.css  
...
myotheme-alpha-default-normal.css
...
myotheme-alpha-default-wide.css
